...
public partial class MytaskPage: BasePage
{
    ...
    {
        [Uno.WeakReference] internal readonly MytaskPage __parent;
        [Uno.WeakReference] internal readonly MytaskPage __parentInstance;
        public Template(MytaskPage parent, MytaskPage parentInstance): base(null, false)
        {
            __parent = parent;
        ...
        public override object New()
        {
            ...
            global::Fuse.Gestures.Clicked.AddHandler(temp6, temp_eb5.OnEvent);
    ...
    void InitializeUX()
    {
        ...
        temp6.LineNumber = 9;
        temp6.FileName = "Pages/MytaskPage.ux";
